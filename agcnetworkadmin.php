    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <?php
                ...
                $selectqry = mysql_query("select * from agcnetwork");
                ...
                <table class="table table-advance table-hover table-bordered">
                    ...
                    <thead>
                        <tr>
                            ...
                            <a href="agcnetworkinsert.php"><button class="btn btn-app btn-success btn-xs">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>  
                                ...
                                <a href="agcnetworkupdate.php?id=<?php echo $selectdata['id']?>"><button class="btn btn-app btn-info btn-xs">
                                    <i class="ace-icon fa fa-edit"></i>
                                        Edit
                                    </button></a>
                                        
                                <a href="agcnetworkdelete.php?id=<?php echo $selectdata['id']?>"><button class="btn btn-app btn-danger btn-xs">
