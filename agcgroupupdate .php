...
<body>
    ...
    if(isset($_GET['id'])) 
    {
        ...
        $selectquery = mysql_query("select * from agcnetwork where id='$id'");
    ...
    if (isset($_POST['update'])) 
    {
        ...
        $update = mysql_query("update agcnetwork set title='$Title', content='$Content' where id='$id'");
    ...
    ?>
             ...
             <div class="col-md-12 tablestyle">
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" height="500px"  align="center" class="table-advance table-hover">
