...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            $selectqry = mysql_query("select * from slider");
                ...
                <table class="table table-advance table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <a href="sliderinsert.php"><button class="btn btn-app btn-success btn-xs">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>  
                                ...
                                <a href="sliderupdate.php?id=<?php echo $select_pic['id']; ?>"><button class="btn btn-app btn-info btn-xs">
                                    <i class="ace-icon fa fa-edit"></i>
                                        Edit
                                    </button></a>
                                        
                                <a href="sliderdelete.php?id=<?php echo $select_pic['id']; ?>"><button class="btn btn-app btn-danger btn-xs">
