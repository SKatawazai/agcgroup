...
<body>
    ...
    if(isset($_GET['id'])) 
    {
        ...
        $selectquery = mysql_query("select * from agccareer where id='$id'");
    ...
    if (isset($_POST['update'])) 
    {
        ...
        $update_picqry = mysql_query("update agccareer set Title='$Title', Description='$Content' where id='$id'");
                    ...
                    <table width="100%" height="950px"  align="center" class="table-advance table-hover">
                        <div class="form-group">
                            ...
                            <tr>    
                                <td>
                                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                                    <textarea cols="10" rows="30" name="Description" class="ckeditor form-control"><?php echo $selectfetchdata['content']; ?></textarea>
                                    </div>
                                </td>
                            </tr>
