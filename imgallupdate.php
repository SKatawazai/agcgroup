...
<body>
    ...
    if(isset($_GET['id'])) 
    {
        ...
        $selectquery = mysql_query("select * from imgall where id='$id'");
    ...
    if (isset($_POST['update'])) 
    {
        ...
        $update_picqry = mysql_query("update imgall set image='$picpath' , pagename='$pagename' where id='$id'");
    ...
    ?>
             ...
             <div class="col-md-12 tablestyle">
                ...
                <form method="post" enctype="multipart/form-data">
                    <table width="100%" height="600px"  align="center" class="table-advance table-hover">
                        <div class="form-group">
                            ...
                            <tr>
                                <td width="100%">
                                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                                    <input type="text"  class="form-control" placeholder="Pagename" name="pagename" value="<?php echo $selectfetchdata['pagename']; ?>" />
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td height="70">
                                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                                    <input type="submit" name="update" id="" value="Update Data" class="form-control btn btn-success">
                                    </div>
                                </td> 
                            </tr>
                        </div>
