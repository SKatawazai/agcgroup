    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <?php
                ...
                $selectqry = mysql_query("select * from agcabout");
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>  
                                ...
                                <a href="agcaboutupdate.php?id=<?php echo $selectdata['id']?>"><button class="btn btn-app btn-info btn-xs">
                                    <i class="ace-icon fa fa-edit"></i>
                                        Edit
                                    </button></a>
                                        
                                <a href="agcaboutdelete.php?id=<?php echo $selectdata['id']?>"><button class="btn btn-app btn-danger btn-xs">
